...
public class ArticleController {
	...
	void doCommand(String cmd) {
    	 if (cmd.equals("help")) {
				...
				if (targetIndex == -1) {
					...
					detailMenuStart(targetIndex);
				}				
			}
		} 
	
	void detailMenuStart() {
		// 상세보기 명령어 프로그램
	...
	void printArticle(Article article) {
		...
		System.out.println("내용   : 안녕하세요");
		System.out.println("작성자 : 로그인유저명");
		System.out.println("작성일 : 2020.08.20");
